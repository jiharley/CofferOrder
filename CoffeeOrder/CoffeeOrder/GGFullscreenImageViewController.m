...
//    UIView *window = app.keyWindow.superview;
//    
...
//    CGRect imageFrame = CGRectMake(0, screenFrame.size.height/2 - 107, 320, 214);

    self.scrollView = [[UIScrollView alloc] initWithFrame:self.view.bounds];
//    self.scrollView = [[UIScrollView alloc] initWithFrame:imageFrame];
...
//    self.containerView = [[UIView alloc] initWithFrame:imageFrame];
...
//    CGRect endFrame = [self.containerView convertRect:self.containerView.bounds toView:window];
    ...
    //纪鹏 修改的地方---> +20
    center.toValue = [NSValue valueWithCGPoint:CGPointMake(floorf(endFrame.size.width/2),floorf(endFrame.size.height/2 + 20))];
