...
- (void)viewDidLoad
{
    ...
    pageControl.numberOfPages = UserGuideImageNumber;
    pageControl.currentPage = 0;
    pageScroll.delegate = self;
    
    pageScroll.contentSize = CGSizeMake(self.view.frame.size.width * UserGuideImageNumber, self.view.frame.size.height);
}
